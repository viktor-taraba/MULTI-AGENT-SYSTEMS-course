...
# додати як в дз повідомлення від користувача через cli та пам'ять (щоб пам'ятав попередні діалоги в межах сесії)
# додати тести по тулах (для кожного агента окремо) та окремі тести для агента-планувальника (все через deepeval)
