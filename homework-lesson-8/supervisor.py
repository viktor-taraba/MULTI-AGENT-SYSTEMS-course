...
def research_planner(request: str) -> str:
    ...
    """
    print("[Supervisor → Planner]")
    config = {"configurable": {"thread_id": "planner_internal_thread"}}
...
def reseacrh_execution(request: str) -> str:
    ...
    config = {
        ...
        "configurable": {"thread_id": "research_internal_thread"}
    }
...
def research_critic(request: str) -> str:
    ...
    revision_counter += 1
    config = {"configurable": {"thread_id": "critic_internal_thread"}}
